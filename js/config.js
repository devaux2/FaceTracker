...
export const DEFAULT_SETTINGS = {
  ...
  edgeOpacity: 0, // alpha at the faded edge (the simple slider): 0 = transparent, 1 = opaque
  gradStart: 0, // gradient tool: where the fade begins on the edge→centre distance
  gradEnd: 0.5, // gradient tool: where the paint becomes fully solid
  gradHardness: 0, // gradient tool: 0 = smooth ramp, 1 = harsh/step
  showFps: false,
